...
zstdgpu_Validate_Result zstdgpu_ReferenceStore_Validate_DecompressedSequences(const struct zstdgpu_ResourceDataCpu *resourceDataCpu, uint32_t tstArenaTopDwords);
